...
type StudentResponse struct {
	...
	Phone         string                 `protobuf:"bytes,5,opt,name=phone,proto3" json:"phone,omitempty"` // Task 2: เพิ่มฟิลด์เบอร์โทรศัพท์
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type StudentListResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Student       []*StudentResponse     `protobuf:"bytes,1,rep,name=student,proto3" json:"student,omitempty"` // repeated คือการส่งเป็นรายการนักศึกษา
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_student_proto_rawDesc = "" +
	...
	"\x05phone\x18\x05 \x01(\tR\x05phone\"I\n" +
...
var file_proto_student_proto_goTypes = []any{
	...
	(*StudentRequest)(nil),      // 1: student.StudentRequest
...
var file_proto_student_proto_depIdxs = []int32{
	...
	1, // 1: student.StudentService.GetStudent:input_type -> student.StudentRequest
